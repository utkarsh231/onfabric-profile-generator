...
- **Fashion / shopping** — 11.6% of signal (community `0`)
- **Software engineering / ML** — 10.3% of signal (community `1`)
- **News / geopolitics** — 9.7% of signal (community `2`)
- **Mixed interest** — 8.8% of signal (community `5`)
- **Health / medicine** — 8.6% of signal (community `3`)
- **Travel planning** — 8.4% of signal (community `4`)
- **News / geopolitics** — 8.0% of signal (community `6`)

## Top sites (weighted)

- `clickserve.dartsearch.net` (score 53680.4)
- `stackoverflow.com` (score 33774.5)
- `gov.uk` (score 21974.8)
- `amazon.co.uk` (score 19799.5)
- `tripadvisor.co.uk` (score 17507.9)
- `github.com` (score 16863.9)
- `nhs.uk` (score 14851.9)
- `medium.com` (score 13905.7)
- `independent.co.uk` (score 12911.2)
- `techcrunch.com` (score 12846.5)

## Top entities (semantic)


## Top searches (distinctive intent)

- `sku cloud blog` (score 26366.8)
- `ukraine` (score 24675.2)
- `metropolitan wharf postcode` (score 18127.6)
- `keats` (score 17889.9)
- `kcl email` (score 15441.7)
- `otta` (score 14744.2)
- `kcl student records` (score 14665.4)
- `wrds database` (score 14639.3)
- `madison 12 hour pump` (score 14368.1)
- `burberry quilted jacket` (score 13240.5)

## Top utility/admin searches (separate lane)

- `after tax calculator` (score 2.8)
- `barclays login` (score 2.6)
- `time in india` (score 2.1)
- `restaurants near me` (score 1.7)
- `speed test` (score 1.4)
- `cm to inches` (score 1.2)
- `tsb login` (score 1.0)
- `waitrose near me` (score 1.0)
- `eu settlement scheme login` (score 1.0)
- `india map` (score 1.0)
